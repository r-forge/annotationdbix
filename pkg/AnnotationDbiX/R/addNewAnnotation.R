...
setGeneric("addNewAnnotation", function(x,data,tablename,data.colnames) standardGeneric("addNewAnnotation"))

## FilePath
setMethod("addNewAnnotation", signature("character","data.frame","character","character"), function(x,data,tablename,data.colnames) 
{
	## Check Parameter
	if(!file.exists(x))
...
## SQLite-Connection
setMethod("addNewAnnotation", signature("SQLiteConnection","data.frame","character","character"), function(x,data,tablename,data.colnames) 
{	
	con <- x
