...
setGeneric("makeDbX", 
	function(probeList,organism,species,prefix,chipSrc,baseMapTableName,outputDir,version,manufacturer,chipName,manufacturerUrl,author,maintainer) standardGeneric("makeDbX"))
